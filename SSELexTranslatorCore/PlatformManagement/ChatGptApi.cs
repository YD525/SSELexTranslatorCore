...
namespace SSELexTranslatorCore.PlatformManagement
{
    ...
    public class ChatGptApi
    {
        public ChatGptRootobject CallAI(string Msg)
        {
            ...
            NChatGptItem.model = Translator.CurrentSetting.ChatGptModel;
        ...
        public ChatGptRootobject CallAI(ChatGptItem Item)
        {
            ...
            Headers.Add("Authorization", string.Format("Bearer {0}", Translator.CurrentSetting.ChatGptKey));
            ...
            try
            {
                DelegateHelper.SetLog("ChatGpt:" + GetResult);
