...
namespace SSELexTranslatorCore.PlatformManagement
{
    ...
    public class DeepSeekApi
    {
        ...
        public DeepSeekRootobject CallAI(string Msg)
        {
            ...
            NDeepSeekItem.model = Translator.CurrentSetting.DeepSeekModel;
        ...
        public DeepSeekRootobject CallAI(DeepSeekItem Item)
        {
            ...
            Headers.Add("Authorization", string.Format("Bearer {0}", Translator.CurrentSetting.DeepSeekKey));
            ...
            try
            {
                DelegateHelper.SetLog("DeepSeek:" + GetResult);
