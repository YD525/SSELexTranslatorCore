...
namespace SSELexTranslatorCore.PlatformManagement
{
    ...
    public class DeepLApi
    {
        ...
        public DeepLResult CallAI(DeepLItem Item)
        {
            ...
            Headers.Add("Authorization", string.Format("DeepL-Auth-Key {0}", Translator.CurrentSetting.DeepLKey));
            string AutoHost = "";

            if (Translator.CurrentSetting.IsFreeDeepL)
            {
            ...
            try
            {
                DelegateHelper.SetLog("DeepL:" + GetResult);
